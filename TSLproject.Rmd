...
if(!require(ggmap)){install.packages("ggpmap"); library(ggpmap)}
if(!require(ggbiplot)){
  if(!require(devtools)){
...
names(pca_pop_town)[2:ncol(pca_pop_town)] <-
  c("CODGEO",
    "sex_ratio",
    "dependency_ratio",
    "aged_dep_ratio",
...
print(paste("The new dataset have", nrow(salaryNEW), "units and", 
