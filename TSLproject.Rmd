...
sc <- scale_colour_gradientn(colours =palette(rainbow(8)), limits=c(min(geo_pop_by_codgeo$total_population_log), max(geo_pop_by_codgeo$total_population_log)))
...
pcapop <- prcomp(pca_pop_town[, 2:5], scale=TRUE)
pcapop$rotation
