...
geo <- subset(geo, select = -c(EU_circo, code_region, number_depart, prefecture, circons, eloignement, insee))
```
...
FraMap = ggmap(get_googlemap(center=fra_center, scale=2, zoom=1), extent="normal")
FraMap
...
# most general pairs
pairs(salary[c(3:8, 13, 18:20)], gap=0)
...
ggplot(data=data.frame(sal_y), aes(sal_y^-1)) + 
