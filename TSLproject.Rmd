...
ineq <- subset(ineq, select = -c(princ_resid14, sec_resid14, vac_resid14, pop_2014))
...
="Pays de la Loire" "Pays de la Loire" "Bretagne"         "Aquitaine"        "Pays de la Loire" "Poitou-Charentes"
 "Poitou-Charentes" "Bretagne"         "Pays de la Loire" "Poitou-Charentes" 
...
sol = rep(0, 10)
for (i in 1:10){
    sol[i] = paste(geo_status_work$region[status_work$transfer %in% Rank10[i]] )
}
...
sol = rep(0, 10)
for (i in 1:10){
    sol[i] = paste(geo_status_work$region[status_work$half %in% Rank10[i]] )
}
...
sol = rep(0, 10)
for (i in 1:10){
    sol[i] = paste(geo_ineq$region[ineq$unemp_rate %in% Rank10[i]] )
}
...
# Map ratio 
 urbanrural<-
  ...
  geom_point(aes(x=geo_commune$longitude, y=geo_commune$latitude,
                 colour=aaa),
             data=geo_commune, alpha=1, size=1) +
