...
hist(pop_by_codgeo$total_population_log, xlab="Total Population in log", main = "Total population per town", col ="light blue")

hist(pop_by_codgeo$dependency_ratio, xlab="", main = "", col ="light blue")
hist(pop_by_codgeo$sex_ratio, xlab="", main = "", col ="light blue")
```
...
aged_ratio_distribution <-
  ...
  sc +
  labs(color='') +
  ggtitle("Aged dependency ratio per town")
aged_ratio_distribution
```
...
##########################################RUN THIS PART AFTER RUNNING POP_BY_CODGEO PART ABOVE
# merging
population$CODGEO = as.integer(population$CODGEO)
