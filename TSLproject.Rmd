...
# impute NA using median (only 3) ... move in pre-processing
newDat$median_living14[is.na(newDat$median_living14)] = median(newDat$median_living14, na.rm = T)
...
x = cbind.data.frame(pop = newDat$total_population, 
                     ...
                     # lev_ineq14 = newDat$lev_ineq14, # 884 NA
                     empl = newDat$empl,
