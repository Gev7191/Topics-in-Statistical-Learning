...
Choose the working directory according to the user path: [but the project will be moved soon on GitHub]
```{r}
# Jisu
# setwd("/Users/jisukim/Documents/TSL_INSEE data")
# Luca
setwd("C:/Users/Luca/Desktop/PhD SNS/Classes/Topics in Statistical Learning/Project")
# Gevorg
...
geo <- subset(geo, select = -c(EU_circo, code_région, numéro_département, préfecture, numéro_circonscription, codes_postaux, éloignement))
# change names 
names(geo)[1:5] = 
  c("region", 
    "region_capital", 
