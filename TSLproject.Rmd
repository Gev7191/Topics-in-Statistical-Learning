...
educ <- subset(educ, select= c(female_NoDip, male_NoDip, 
                               female_Sec, male_Sec, 
                               female_Hi, male_Hi, 
...
status_work <- subset(status_work, select = c(wagearner_M, wagearner_F, 
...
#Drop unnecessary variables
commune <-subset(commune, select=-c(scorefiscal, dep, reg, evolutionpop, nbpropritaire, 
...
# rename variables  
names(commune)[c(1, 3:ncol(commune))] <-c("CODGEO", "LIBGEO", "demo_index", "population", "nb_household", 
                                          ...
                                          "nb_created_construction", "nb_created_commerce", "nb_created_services", 
                                          "urbanRural", "nb_active", "nb_active_employees", 
