...
#remove regions with null values
selected_PCA_var <- selected_PCA_var[-c(12, 15, 19, 20, 28)]
#check
#str(firms_var)
...
# creates common covariance matrix S
s <- 0
for (v in c(1:23)) S <- S + regions_count_sub$Freq[v] * as.matrix(selected_PCA_var[[v]])
S <- S / 5024
...
selected_cen
selected_cen <- selected_cen[-c(12, 15, 19, 20, 28)]
str(selected_cen)
