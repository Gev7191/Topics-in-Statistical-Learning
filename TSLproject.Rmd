...
# [KEEP DEPT. NUM?]
#  [éloignement is the distance from where?]
...
ggplot(salary, aes(x= sal_executive, y= salary_ratio_FvsM_Exec)) + 
  geom_point(size = 0.5, colour = "#0091ff")+
  geom_smooth()
...
ggplot(salary, aes(x= sal_midManager, y= salary_ratio_FvsM_midManag)) + 
  geom_point(size = 0.5, colour = "#0091ff")+
  geom_smooth()
...
ggplot(salary, aes(x= sal_worker, y= salary_ratio_FvsM_worker)) + 
  geom_point(size = 0.5, colour = "#0091ff")+
  geom_smooth()
...
ggplot(salary, aes(x= sal_employee, y= salary_ratio_FvsM_employee)) + 
  geom_point(size = 0.5, colour = "#0091ff")+
  geom_smooth()
...
pca_pop_town <- ddply(geo_pop_by_town, .(town_name), function(geo_pop_by_town) {
  data.frame(geo_pop_by_town$CODGEO,  geo_pop_by_town$sex_ratio, geo_pop_by_town$dependency_ratio, geo_pop_by_town$aged_dependency_ratio, geo_pop_by_town$child_dependency_ratio, geo_pop_by_town$total_population_log)})

# rename the variables 
names(pca_pop_town)[2:ncol(pca_pop)] <-
  c("CODGEO",
    "sex_ratio",
    "dependency_ratio",
    "aged_dep_ratio",
