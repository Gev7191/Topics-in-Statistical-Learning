...
```
There are three main directions of eigenvectors
contributing to principal components' scores: variables describing salaries of ordinary staff
across different age categories, variables describing mid-manager and manager salaries, and
salaries of executives.

PCA on delta M-F revealed three main directions
of eigenvectors contributing to scores: male-female salary differences of mid-managers,
executives, and 51 and older aged people.
...
multicollinearity among the variables of the firms data, the conducted PCA results
in the variable with considerably higher values, i.e. very small firms, to form a main
eigenvector, leaving firms of other sizes to form a separate group of eigenvectors.
...
```
PCA conducted
on the commune dataset revealed two main directions of eigenvectors:
proportion of active employers in each town, and industry related variables.
...
```
regional GDP is a striking important
factor, comprising a distinctly oriented eigenvector. Another distinct eigenvector, though less
substantial, is the unemployment rate.
