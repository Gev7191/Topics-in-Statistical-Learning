...
\begin{frame}{\textcolor{bscuro}{Demographic profiles}}
	...
	\begin{figure}[!ht] 
		\centering
		\subfloat{{\includegraphics[width=0.47\textwidth]{DDis_pop.jpeg} }}
...
\begin{figure}[!ht] 
	\centering
	\subfloat{{\includegraphics[width=0.5\textwidth]{Pca_pop.jpeg} }}
	\subfloat{{\includegraphics[width=0.5\textwidth]{Biplot_pop.jpeg} }}
