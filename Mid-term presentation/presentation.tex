...
\begin{frame}{\textcolor{bscuro}{Demographic profiles}}
	...
	\begin{figure}[!ht] 
		\centering
		\subfloat{{\includegraphics[width=0.46\textwidth]{DDis_pop.jpeg} }}
...
\begin{frame}{\textcolor{bscuro}{Demographic profiles}}
	\begin{figure}[!ht] 
		\centering
		\subfloat{{\includegraphics[width=0.7\textwidth]{Biplot_pop.jpeg} }}
	\end{figure}
\end{frame}
...
\begin{frame}{\textcolor{bscuro}{ANOVA using sex, job, age and interaction effects}}
	\begin{figure}[!ht] 
		\centering
		\subfloat{\includegraphics[width=0.6\textwidth]{ANOVA_dataY.jpeg}} 
	\end{figure}
\end{frame}
