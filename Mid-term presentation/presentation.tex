...
\begin{frame}{\textcolor{bscuro}{Distribution of population per town}}
	...
	\begin{figure}[!ht] 
		\centering
		\subfloat{{\includegraphics[width=0.55\textwidth]{DDis_pop.jpeg} }}
		\subfloat{{\includegraphics[width=0.5\textwidth]{tot_pop.jpeg} }}
	\end{figure}
\end{frame}
...
\begin{frame}{\textcolor{bscuro}{Population demographics}}
	\begin{figure}[!ht] 
		...
		\subfloat{{\includegraphics[width=0.4\textwidth]{Aged.jpeg} }}
	\end{figure}
\end{frame}
...
\begin{figure}[!ht] 
	\centering
	\subfloat{{\includegraphics[width=0.6\textwidth]{Biplot_pop.jpeg} }}
\end{figure}
\end{frame}
...
\begin{frame}{\textcolor{bscuro}{ANOVA}}
	\begin{figure}[!ht] 
		\centering
		\subfloat{\includegraphics[width=0.5\textwidth]{ANOVA_factors.jpeg}} 
		\subfloat{\includegraphics[width=0.5\textwidth]{ANOVA_factors_randomized.jpeg}}
	\end{figure}
\end{frame} 
...
\begin{frame}{\textcolor{bscuro}{ANOVA}}
	\begin{figure}[!ht] 
		\centering
		\subfloat{\includegraphics[width=0.4\textwidth]{ANOVA_dataY.jpeg}} 
		\subfloat{\includegraphics[width=0.5\textwidth]{ANOVA_model.jpeg}} 
	\end{figure}
\end{frame}


\begin{frame}{\textcolor{bscuro}{ANOVA BSS}}
\begin{figure}[!ht] 
	\centering
	\subfloat{\includegraphics[width=0.6\textwidth]{ANOVA_BSS.jpeg}} 
	\subfloat{\includegraphics[width=0.4\textwidth]{ANOVA_BSS_bic.jpeg}}
\end{figure}
\end{frame}


\begin{frame}{\textcolor{bscuro}{ANOVA GW-Lasso}}
\begin{figure}[!ht] 
	\centering
	\subfloat{\includegraphics[width=0.35\textwidth]{ANOVA_CV_GWLasso.jpeg}} 
	\subfloat{\includegraphics[width=0.35\textwidth]{ANOVA_coeff_lambd.jpeg}} 	
	\subfloat{\includegraphics[width=0.35\textwidth]{ANOVA_interc_lambd.jpeg}} 
\end{figure}
\end{frame}


\begin{frame}{\textcolor{bscuro}{Prediction for young people}}
\begin{figure}[!ht] 
	\centering
	\subfloat{\includegraphics[width=0.5\textwidth]{sal_regr_resp_sampled_noOut.jpeg}} 
	%		\qquad
	\subfloat{\includegraphics[width=0.6\textwidth]{sal_regr_scatter_model.jpeg}}
\end{figure}
\end{frame}
...
\begin{frame}{\textcolor{bscuro}{Elastic net and and 10-folds CV}}
	\begin{figure}[!ht] 
		\centering
		\subfloat{\includegraphics[width=0.7\textwidth]{elasticNet_10foldsCV.jpeg}} 
	\end{figure}
\end{frame}
